    ...
    return (
        <div>
            {(!homepagedata || loading || !homepagedata) ? (
                ...
                <>
                    {/* Passing the searchpagedata to the First component as props */}
                    <First searchpagedata={homepagedata.topSearchPage} />

                    {/* Home second page with mission data */}
                    <Home_v2_second_page className="homesecondpage" secondpagedata={homepagedata.ourMissionPage} />

                    {/* Home third page with testimonials */}
                    <Home_v2_third_page className="homethirdpage" thirdpagedata={homepagedata.testimonialPage} />

                    {/* Home fourth page - assumes no data needed */}
                    <HomeFourthPage />

                    {/* Home fifth page with top and bottom search data */}
                    <Home_v2_fifth_page
                        className="homefifthpage"
                        searchpagedata={homepagedata.topSearchPage}
                        fifthpagedata={homepagedata.bottomSearchPage}
                    />
                </>
            )}
        </div>
