...
import "./clinics_card_v2.scss";
import { useState, useEffect } from "react";
// import axios from "axios";
import ClinicModal_v2 from "../ClinicModal/ClinicModal_v2";
import { ClinicFilterContext } from "../ClinicContext/ClinicFilterContext_v2";

const Clinics_card_v2 = ({ clinicdata }) => {
  ...
  return (
    <>
      ...
      <div className="clinics-main-scroll">
        <h2 className="clinic-heading">CLINICS AND HOSPITALS</h2>
                    ...
                    <div className="clinics-card">
                      ...
                      <div className="clinics-card-summary">
                        ...
                        <p className="clinics-summary clinics-m">
                          <img id="clinic-mobile-icon" src={process.env.PUBLIC_URL +"/images/Ringer_volume.png"}  alt="" /> {clinic.contact}
                        </p>
                      </div>
                    </div>
                  </div>
...
export default Clinics_card_v2;
