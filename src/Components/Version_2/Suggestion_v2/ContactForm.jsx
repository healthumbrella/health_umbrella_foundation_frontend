      ...
      <div className="main_form_div">
        ...
        <div className="form_left">
          ...
          <div className="form fourthrow">
            ...
            <input type="text" id="disease" name="disease" value={formData.disease} onChange={handleChange} placeholder="Disease" /> 
          {/* </div>
          <div className="form fourthrow"> */}

            <label htmlFor="pathies"></label>
            <input type="text" id="disease" name="pathies" value={formData.pathies} onChange={handleChange} placeholder="Pathies" /> 
          </div>
        ...
        <div className="form_right">
          <div className="form form_col">
              
            <label htmlFor="house"></label>
            <input type="text" id="house" name="house" value={formData.house} onChange={handleChange} placeholder="House/Street/Landscape*" required /> <br/>
           
              <label htmlFor="email_address"></label>
              <input type="email" id="email" name="email_address" value={formData.email_address} onChange={handleChange} placeholder="Email*" required /> <br /> 
              
              <label htmlFor="city"></label>
              <input type="text" id="city" name="city" value={formData.city} onChange={handleChange} placeholder="City*" required /> <br />
               
              <label htmlFor="country"></label>
              <input type="text" id="country" name="country" value={formData.country} onChange={handleChange} placeholder="Country*" required /> <br /> 
           
              <label htmlFor="phone_number"></label>
              <input type="tel" id="phone" name="phone_number" value={formData.phone_number} onChange={handleChange} placeholder="Phone No" /> <br /> 
              
              <label htmlFor="state"></label>
              <input type="text" id="state" name="state" value={formData.state} onChange={handleChange} placeholder="State*" required /> <br /> 
