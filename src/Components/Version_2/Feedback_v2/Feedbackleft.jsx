    ...
    const handleSubmit = async (e) => {
      ...
      return (
        <form onSubmit={handleSubmit} className="feedback" encType="multipart/form-data">
          <div className="fb_heading" style={{color:"#005985"}}>
           We want your feedback
            ...
            <div style={{display:'flex'}}>
            {
              [...Array(5)].map((star,index)=>{
                ...
                return (
                  ...
                  <FaStar 
                  size={30} 
                  style={{cursor:"pointer",stroke:"#ffc107",strokeWidth:50,margin:5}}
                  color={currentRating<=(hover||rating)?"ffc107":"transparent"}
                  onMouseEnter={()=>
            ...
            <div  className="fb_button" >
                <input /* className="fb_submit"*/ type="submit" value="Submit" style={{backgroundColor:"#005985"}}/>
            </div>
            </div>
